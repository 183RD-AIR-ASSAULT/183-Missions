/* General config */
L_ambiDrive_maxCivs                 = 2;		// Maximum number of civilian vehicles driving around at any time
L_ambiDrive_minSpawnDistance 		= 1000;		// Minimum distance to players when spawning vehicles
L_ambiDrive_maxDistanceToPlayers    = 2500;		// Maximum distance to players, both for spawning and deleting vehicles


/* Speed limits */
L_ambiDrive_speedLimitCity = 25;				// Speed limit (in km/h) within cities
L_ambiDrive_speedLimit 	   = 40;				// Speed limit (in km/h) outside of cities
