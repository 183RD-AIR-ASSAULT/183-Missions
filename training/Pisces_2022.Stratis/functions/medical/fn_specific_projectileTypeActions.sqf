 ...
 *
 * Example:
 * [controller, stretcher, bodyPart] call OETA_Pisces_Medical_fnc_specific_projectileTypeActions
 */
...
private _actions = [];
{
    ...
    private _projectileTypeAction = [
        ...
        {},
        {true},
        {(_this select 2) call OETA_Pisces_Medical_fnc_specific_severityActions},
